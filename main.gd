...
var unitInfo = [
	 ...
	 'units/Tank', "res://assets/VO-entiteti/tank/tank.glb", Vector3(0,-0.464,0), Vector3(0,0,0), Vector3(0.005,0.005,0.005),
	 'units/Cavalry', "res://assets/VO-entiteti/cavalry/scene.gltf", Vector3(0,-0.318,0), Vector3(0,0,0), Vector3(0.3,0.3,0.3),
	 'units/AdvancedRanged', "res://assets/VO-entiteti/ranged/ranged.glb", Vector3(0,-0.452,0), Vector3(0,0,0), Vector3(0.33,0.33,0.33),
	 'units/Scout', "res://assets/VO-entiteti/scout/scene.gltf", Vector3(0,-0.452,0), Vector3(0,0,0), Vector3(0.015,0.015,0.015),
	 'units/AdvancedTank', "res://assets/VO-entiteti/tank/tank.glb", Vector3(0,-0.464,0), Vector3(0,0,0), Vector3(0.005,0.005,0.005),
	 'units/Ranged', "res://assets/VO-entiteti/ranged/ranged.glb", Vector3(0,-0.452,0), Vector3(0,0,0), Vector3(0.33,0.33,0.33),
	 'buildings/UnitUpgrader', "res://assets/VO-entiteti/unit_upgrader/scene.gltf", Vector3(0,-0.484,0), Vector3(0,0,0), Vector3(0.01,0.01,0.01),
	 'buildings/Capital', "res://assets/VO-entiteti/main_city/scene.gltf", Vector3(0,0.12,0), Vector3(0,0,0), Vector3(0.1,0.1,0.1),
	 'buildings/Barracks', "res://assets/VO-entiteti/barracks/scene.gltf", Vector3(0.375,-0.423,-0.3), Vector3(0,0,0), Vector3(0.66,0.66,0.66),
	 ...
	 'buildings/unit_generators/TankGenerator', "res://assets/VO-entiteti/tank_generator/scene.gltf", Vector3(0,0,0), Vector3(0,0,0), Vector3(0.75,0.75,0.75),
